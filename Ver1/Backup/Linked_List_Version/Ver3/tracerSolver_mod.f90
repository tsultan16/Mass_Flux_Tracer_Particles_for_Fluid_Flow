MODULE tracersolver_mod
	...
	CONTAINS
		...
		!
		! Loop over cells. Cycle through the cell faces (in the order right, 
        ! left, top, bottom). For each face: 
		!
        ...
        ! routine for performing a single tracer exchange between two cells
